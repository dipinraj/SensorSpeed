...
package com.faisons.android.speedtest;

import com.faisons.android.speedtest.SmsRemote.SmsRemoteReceiver;
import com.google.android.noisealert.R;
...
//	private SmsRemote mRemote;
	...
	private Runnable mPollTask = new Runnable() {
		public void run() {
			...
			if (mTestMode) updateDisplay("testing...", amp, count);
			else           updateDisplay("monitoring...", amp, count);
...
//			}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mCounterView =  (TextView) findViewById(R.id.textView1);
...
//			callForHelp();
	...
	private void stop() {
		...
		updateDisplay("stopped...", 0.0, count);
	...
	private void sleep() {
		mSensor.stop();
		updateDisplay("paused...", 0.0, count);
		setActivityLed(false);
	...
	private void updateDisplay(String status, double signalEMA, int count) {
		mStatusView.setText(status);
		mCounterView.setText("Rotation Count " + count);
